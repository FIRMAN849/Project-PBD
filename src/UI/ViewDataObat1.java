 ...
 * @author adeln
 */
public class ViewDataObat1 extends javax.swing.JFrame {

    public static DefaultTableModel tableModel;
    
    public ViewDataObat1() {
        initComponents();
        initTabelObat();
        datatable("");
    }
    private void initTabelObat(){
    String[] obatColums = new String[]{"ID", "Nama Obat","Harga Beli", "Harga jual" , "Stok", "Jenis Obat" ,"tanggal Masuk Obat" , "tanggal kadaluarsa","Suplier"};
        int[] columnWidth = {
        70,500,200,200,200,200,200,200,200
        };
        
        tableModel = new DefaultTableModel(obatColums,0);
        ObatTabel.setModel(tableModel);
        ObatTabel.setRowHeight(20);
        
        int i = 0;
        for(int width : columnWidth){
            TableColumn column = ObatTabel.getColumnModel().getColumn(i++);
    ...
    public void datatable(String nama) {
         DefaultTableModel model = (DefaultTableModel) ObatTabel.getModel();
        try{
            model.setRowCount(0);
            java.sql.Statement statement = (java.sql.Statement)konek.GetConnection().createStatement();
            ResultSet rs = statement.executeQuery("SELECT * FROM data_obat WHERE nama_obat Like '%" + nama + "%'");
            while (rs.next()){
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(ObatTabel);
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        // TODO add your handling code here:
        try {
            int baris = ObatTabel.getSelectedRow();
            String id = (String) ObatTabel.getValueAt(baris, 0);
            
            java.sql.Statement statement = (java.sql.Statement)konek.GetConnection().createStatement();
            ResultSet rs = statement.executeQuery("SELECT * FROM data_obat WHERE kode_obat ='" + id + "'");
            ...
            if(rs.next()){
                ...
                if(konfirmasi == JOptionPane.YES_NO_OPTION){
                   statement.executeUpdate("DELETE FROM data_obat WHERE kode_obat ='" + id + "'");
                   datatable("");
                }
        }
            ...
            System.out.println("Error hapus obat " + e);
        }
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        ...
        try {
            int baris = ObatTabel.getSelectedRow();
            FormTambahObat.id_obat  = (String) ObatTabel.getValueAt(baris, 0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDataObat1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewDataObat1().setVisible(true);
            }
        });
    }
